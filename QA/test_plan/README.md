...
1. Главная страница:
    1. Хэдер 
        - кнопка Логотип  FE/GI
        - кнопка Наша команда FE/GI
        - кнопка Вход/Личный кабинет FE/GI
    2. Боди 
        - текст О проекте FE/GI
        - Блок «Пройти собеседование» FE/GI
        - Блок «Голодные игры» FE/GI
        	- Блок «Голодные игры» FE/GI Активен только по параметру включаемому администратором FE/GI
    3. Футер
        - линк Копирайт FE/GI
        - линк Соглашение FE/GI
        - линк Правила сервиса FE/GI
        - линк Контакты FE/GI

2. Личный кабинет пользователя:
    1. функция Регистрация FE/BE/GI/DB
    2. функция Авторизация и аутентификация FE/BE/GI/DB
    3. функция Выход из учетной записи FE/BE/GI
    4. функция Изменение данных учетной записи FE/BE/GI/DB

3. Личный Кабинет Супер-Администратора
    1. функция Авторизация и аутентификация FE/BE/GI/DB
    2. функция Выход из учетной записи FE/BE/GI
    3. функция Изменения данных учетной записи FE/BE/GI/DB
    4. функция Управление командой (Включение юзерам «Голодные игры») FE/BE/GI/DB

4. Пройти собеседование
    1. список Выбор специальности FE/BE/GI/DB
    2. список Выбор количество вопросов FE/BE/GI/DB 
    3. список Выбор грейда FE/BE/GI/DB
    4. блок "Вопрос" FE/BE/GI/DB
    5. страница Окончание собеседование FE/GI
    	- Счетчик вопросов BE/DB
...
5. блок Голодные игры FE/BE/GI/DB
    1. список Выбор специальности FE/BE/GI/DB
    2. список Выбор количество вопросов FE/BE/GI/DB
    3. список Выбор грейда FE/BE/GI/DB
    4. блок "Вопрос" FE/BE/GI/DB
    5. страница Итог «Голодных игр» FE/BE/GI
